                    ...
                    <form action="{{route('supplier.update',$supplier->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input  type="text"  value="{{$supplier->supplier_contact_whatsaap}}" name="supplier_contact_whatsaap" class="form-control" placeholder="Whatsapp">
                            </div>
                        </div>
                        <br>
                        {{-- 5 --}}
                        <div class="row">
                            <div class="col">
                                ...
                                <input  type="text"  value="{{$supplier->supplier_catelouge}}" name="supplier_catelouge" class="form-control" placeholder="Cateloge">
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input  type="text"  value="{{$supplier->supplier_fixed_quotation1}}" name="supplier_fixed_quotation1" class="form-control" placeholder="quotation 1">
                            </div>
                            <div class="col">
                                <label for="supplier_fixed_quotation2" class="control-label">Supplier fixed quotation 2</label>
                                <input  type="text"  value="{{$supplier->supplier_fixed_quotation2}}" name="supplier_fixed_quotation2" class="form-control" placeholder="quotation 2">
                            </div>
                        </div>
                        <br>
                        {{-- 7 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input  type="text"  value="{{$supplier->factory_location}}" name="factory_location" class="form-control" placeholder="Location">
                            </div>
                            <div class="col">
                                <label for="office_location" class="control-label">Supplier IBAN2</label>
                                <input  type="text"  value="{{$supplier->office_location}}" name="office_location" class="form-control" placeholder="Location">
                            </div>
                        </div>
                        <br>
                        {{-- 13 --}}
