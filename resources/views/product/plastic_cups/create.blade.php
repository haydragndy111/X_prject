                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="product_name" class="form-control">
                                    <option value="" selected disabled>...</option>
                                    <option value="Paper Bag With Flat Handle Kraft Brown">@lang('lang.Paper Bag With Flat Handle Kraft Brown')</option>
                                    <option value="Plastic CupU-Shaped PP Clea">@lang('lang.Plastic CupU-Shaped PP Clear')</option>
                                    <option value="Plastic Cup Sauce PP Black">@lang('lang.Plastic Cup Sauce PP Black')</option>
                                    <option value="Plastic Cup IceCream PET Black">@lang('lang.Plastic Cup IceCream PET Black')</option>
                                </select>
                            </div>
                            {{-- <div class="col">
